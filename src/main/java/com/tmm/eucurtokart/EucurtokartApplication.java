...
public class EucurtokartApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Usuario usuario2 = new Usuario(null, "Tiago Martins", "tiagomartins@tiago.com.br");
		Usuario usuario3 = new Usuario(null, "TMM", "tmm@tmm.com.br");

		Evento evento1 = new Evento(null, "Kart animal", "Vamos realizar um evento...", usuario1);
		Evento evento2 = new Evento(null, "Kart Pinhais", "Nessa sexta-feira teremos...", usuario1);
		Evento evento3 = new Evento(null, "Kart São José", "Nesse domingo iniciaremos um novo...", usuario2);

		Postagem postagem1 = new Postagem(null, "Descrição da postagem 1", LocalDate.now(), true, usuario1);
		Postagem postagem2 = new Postagem(null, "Descrição da postagem 2", LocalDate.now(), true, usuario2);
		Postagem postagem3 = new Postagem(null, "Descrição da postagem 3", LocalDate.now(), true, usuario1);

		Comentario comentario1 = new Comentario(null, "Descrição do comentário 1", LocalDate.now(), true, postagem1,
				usuario1);
		Comentario comentario2 = new Comentario(null, "Descrição do comentário 2", LocalDate.now(), true, postagem2,
				usuario2);
		Comentario comentario3 = new Comentario(null, "Descrição do comentário 3", LocalDate.now(), true, postagem3,
				usuario1);

		FotoPostagem fotoPostagem1 = new FotoPostagem(null, "foto.jpg", true, LocalDate.now(), postagem1);
		FotoPostagem fotoPostagem2 = new FotoPostagem(null, "foto.png", true, LocalDate.now(), postagem2);
		FotoPostagem fotoPostagem3 = new FotoPostagem(null, "foto.svg", true, LocalDate.now(), postagem3);

		UsuarioSeguidor usuarioSeguidor1 = new UsuarioSeguidor(null, true, LocalDate.now(), usuario1);
		UsuarioSeguidor usuarioSeguidor2 = new UsuarioSeguidor(null, true, LocalDate.now(), usuario1);
		UsuarioSeguidor usuarioSeguidor3 = new UsuarioSeguidor(null, true, LocalDate.now(), usuario3);

		FotoEvento fotoEvento1 = new FotoEvento(null, evento1, "foto1.png", LocalDate.now(), true);
		FotoEvento fotoEvento2 = new FotoEvento(null, evento1, "foto2.png", LocalDate.now(), true);
		FotoEvento fotoEvento3 = new FotoEvento(null, evento2, "foto1.png", LocalDate.now(), true);

		ParticipanteEvento participanteEvento1 = new ParticipanteEvento(null, evento1, usuario1, true, LocalDate.now(),
				LocalDate.now(), true, "Primeiro Lugar", LocalDate.now());
		ParticipanteEvento participanteEvento2 = new ParticipanteEvento(null, evento1, usuario2, true, LocalDate.now(),
				LocalDate.now(), true, "Segundo Lugar", LocalDate.now());
		ParticipanteEvento participanteEvento3 = new ParticipanteEvento(null, evento1, usuario3, true, LocalDate.now(),
